      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
        <div className="bg-white p-12 rounded-3xl shadow-sm text-center max-w-md w-full border border-gray-100">
          ...
          {manualPaymentMethods.length > 0 && orderId && (
            <div className="mb-8 text-left border border-purple-100 rounded-3xl overflow-hidden bg-white shadow-sm max-w-lg w-full mx-auto">
              <div className="bg-purple-50 p-5 border-b border-purple-100 text-center sm:text-left">
                ...
                <p className="text-sm text-purple-700 mt-1 font-medium">Please complete your payment using one of the methods below.</p>
              </div>
                ...
                {manualPaymentMethods.map((method: any, idx: number) => (
                  <div key={idx} className="pb-4 border-b border-gray-100 last:border-0 last:pb-0">
                    <div className="flex items-center gap-2 mb-2 justify-center sm:justify-start">
                      ...
                      <span className="text-xs font-bold text-gray-500 bg-gray-100 px-3 py-1 rounded-full">{method.type}</span>
                    </div>
                    <p className="font-mono font-black text-xl text-gray-900 mb-2 text-center sm:text-left tracking-tight">{method.number}</p>
                    {method.instructions && (
                      <p className="text-sm text-gray-600 bg-gray-50 p-4 rounded-2xl border border-gray-100 text-center sm:text-left font-medium">{method.instructions}</p>
                    )}
                  </div>
                ))}
              </div>
