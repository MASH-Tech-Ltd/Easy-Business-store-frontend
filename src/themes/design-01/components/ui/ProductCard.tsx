      ...
      {isList ? (
        ...
        <div className="p-5 flex flex-col flex-1">
          ...
          <div className="mt-auto flex sm:grid sm:grid-cols-2 gap-1.5 sm:gap-2">
            <button
              onClick={handleAddToCart}
              className="flex items-center justify-center shrink-0 w-9 h-9 sm:w-full sm:h-auto sm:py-2.5 border-2 rounded-lg hover:opacity-80 transition-opacity font-semibold"
              title="Add to Cart"
              style={{
            ...
            <button
              onClick={handleBuyNow}
              className="flex-1 sm:w-full flex items-center justify-center gap-1 sm:gap-2 py-2 sm:py-2.5 text-white rounded-lg hover:opacity-90 transition-opacity shadow-sm font-semibold text-[11px] sm:text-sm"
              title="Buy Now"
              style={{
